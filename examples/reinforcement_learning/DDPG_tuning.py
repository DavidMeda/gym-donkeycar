...
def sample_DDPG_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    model = DDPG("MlpPolicy", env, **result)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name_model", type=str, default="DDPG", help="location of log dir")
    ...
    conf = {
        ...
        "font_size": 30,
        "racer_name": "DDPG",
        "bio": "Learning to drive w DDPG RL",
        "guid": str(uuid.uuid4()),
        "max_cte": 1.5,
    ...
    study.optimize(sample_DDPG_params, n_trials=50)
