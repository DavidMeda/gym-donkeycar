...
if __name__ == "__main__":
    ...
    #               "Average Absolute CTE", "Min Absolute CTE", "Max Absolute CTE", "Hit", "Num lap", "Avg time lap", 
    #               "Best time lap", "Exit right lane", "Percent exit right lane"])
    try:
        ...
        for episode in range(n_episode):
            ...
            while not done:
                ...
                # if num_lap >= 3:
                #     print(
                #         f" Stopping EVALUATION with TOT {time_step} steps, the TD3 model reached laps={num_lap}")
                #     done = True
                # if time_step >= 2600:
                #     print(
